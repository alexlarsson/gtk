 ...
 *
 * #GtkFileChooserNatve inherits from #GtkNativeDialog, which means it
 ...
 *
 * * An extra widgets added with gtk_file_chooser_set_extra_widget().
 *
...
{
  /* We always create a File chooser dialog and delegate all propertis to it.
